...
module ActionController
  module Rendering
    ...
    RENDER_FORMATS_IN_PRIORITY = %i[body plain html].freeze
    ...
    def _process_variant(options)
      return unless defined?(request) && !request.nil? && request.variant.present?
    ...
    def _set_rendered_content_type(format)
      return unless format && !response.media_type

      self.content_type = format.to_s
    end

    def _set_vary_header
      return unless response.headers['Vary'].blank? && request.should_apply_vary_header?
