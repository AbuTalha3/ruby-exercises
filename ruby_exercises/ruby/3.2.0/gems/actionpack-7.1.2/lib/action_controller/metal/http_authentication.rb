  ...
  module HttpAuthentication
        ...
        module ClassMethods
          ...
          def http_basic_authenticate_with(name:, password:, realm: nil, **options)
            ...
            unless password.is_a?(String)
              raise ArgumentError,
                    "Expected password: to be a String, got #{password.class}"
            end
    ...
    module Digest
      ...
      def validate_digest_response(request, realm, &password_procedure)
        ...
        return unless valid_nonce && realm == credentials[:realm] && opaque(secret_key) == credentials[:opaque]
    ...
    module Token
      ...
      WHITESPACED_AUTHN_PAIR_DELIMITERS = /\s*#{AUTHN_PAIR_DELIMITERS}\s*/.freeze
